...
// http://www.uoguide.com/UOAM:geo

namespace VitaNex.SuperGumps.UI
{
    public class SuperShardTravelGump : SuperGump
    {
        public static void Initialize()
        {
            CommandUtility.Register("SSTravel", AccessLevel.Counselor, e => DisplayTo(e.Mobile as PlayerMobile));
        }

        public static void DisplayTo(PlayerMobile user)
        {
            bool roman = EnumerateInstances<SuperShardTravelGump>(user).Any(g => g != null && !g.IsDisposed && g.RomanNumerals);
